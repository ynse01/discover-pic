...
export class BlockSolutions {
    ...
    private static _solutions0 = [0];
    private static _solutions1 = [1, 2, 4, 8, 16, 32, 128, 256];

    private static _solutions2 = [
        3, 5, 6, 9, 10, 12, 17, 18, 20, 24, 33, 34, 36, 40, 48, 65, 66, 68, 
        72, 80, 96, 129, 130, 132, 136, 144, 160, 192, 257, 258, 260, 264,
         272, 288, 320, 384
    ];
    private static _solutions3 = [
    ...
    private static _solutions8 = [
        255, 383, 447, 479, 495, 503, 507, 509, 510
    ];
    private static _solutions9 = [511];
    ...
    private static _generateSolutions(hint: number): number[] {
    ...
    private _elliminateSolutions(cb: (solution: number) => boolean): void {
